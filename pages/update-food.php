                ...
                <div class="container">
                    <div class="row no-gutters">
                                ...
                                <div class="col-md-12 col-lg-7">
                                    <div class="heading-section mt-5 mb-4">
                                        <div class="pl-lg-3 ml-md-5">
                                            <span class="subheading">Update</span>
                                            <h2 class="mb-4">Update the details of your product.</h2>
                                        </div>
                                    </div>
                                    <div class="pl-lg-3 ml-md-5">
                        ...
                        <div class="col-sm-4 p-4 p-md-5 d-flex align-items-center justify-content-center bg-primary">
                            <form action="../php/food/update-food.php" method="post" class="appointment-form" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <input value="'.$row["name"].'" name="name" type="name" class="form-control" placeholder="Product Name">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <input value="'.$row["ingredients"].'" name="ingredients" type="text" class="form-control" placeholder="Ingredients">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                    ...
                                    <input name="id" hidden value="'.$_SESSION["restaurant-id"].'" type="number">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <input value="'.$row["price"].'" name="price" type="number" class="form-control" placeholder="Price">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <input type="submit" value="Update" class="btn btn-white py-3 px-4">
                                        </div>
                                    </div>
                                </div>
                            </form>
